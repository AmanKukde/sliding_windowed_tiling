"""
Setup script for the PAVIA_ATN dataset using MicroSplit reproducibility code.
This script:
...
if __name__ == "__main__":
    model, config, (train_dset, val_dset, test_dset), ckpt_path = setup_environment_PAVIA_ATN()
