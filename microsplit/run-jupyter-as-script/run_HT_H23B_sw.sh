...
# Run inference
/scratch/aman.kukde/conda/envs/msr/bin/python3.10 /home/aman.kukde/sliding_windowed_tiling/microsplit/run-jupyter-as-script/run_notebooks.py --notebook "/home/aman.kukde/sliding_windowed_tiling/MicroSplit-reproducibility/examples/2D/HT_H23B/02_predict_sw.ipynb" --outputdir "/group/jug/aman/microsplit-runs/HT_H23B/notebooks/"